  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/purchases/new"             element={<PL><PurchaseFormPage /></PL>} />
        <Route path="/purchases/:id/edit"        element={<PL><PurchaseFormPage /></PL>} />
        <Route path="/purchases/:id"             element={<PL><PurchaseDetailPage /></PL>} />
